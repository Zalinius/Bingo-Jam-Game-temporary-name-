...
public class Palette {
	public static final Color DEBUG = new Color(1f, 0f, 1f, 0);
	...
	public static final Color RED = new Color(0.8f, 0.0f, 0f);
	public static final Color GREEN = new Color(0.0f, 0.8f, 0.0f);
	public static final Color BLUE = new Color(0.0f, 0.0f, 0.8f);
	public static final Color GRAY = Color.GRAY;
	
	public static final Color RED_BACKGROUND = new Color(0.6f, 0.0f, 0f);
	public static final Color GREEN_BACKGROUND = new Color(0.0f, 0.6f, 0.0f);
	public static final Color BLUE_BACKGROUND = new Color(0.0f, 0.0f, 0.6f);
	public static final Color GRAY_BACKGROUND = GRAY.darker();

	public static final Color RED_DEATH = new Color(0.4f, 0.0f, 0f);
	public static final Color GREEN_DEATH = new Color(0.0f, 0.4f, 0.0f);
	public static final Color BLUE_DEATH = new Color(0.0f, 0.0f, 0.4f);
